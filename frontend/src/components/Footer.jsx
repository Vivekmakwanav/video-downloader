    ...
    <footer style={{ 
      ...
      <div className="footer-grid">
        ...
        <div className="footer-col-brand">
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
            ...
            <span className="text-gradient" style={{ fontSize: '1.3rem', fontWeight: '700', letterSpacing: '-0.5px' }}>NEXUS</span>
          </div>
          ...
          <div style={{ display: 'flex', gap: '16px', marginTop: '8px' }}>
            ...
            <a href="mailto:support@nexus.app" style={{ color: 'var(--text-secondary)', transition: 'color 0.2s', display: 'flex', alignItems: 'center' }} onMouseOver={e => e.currentTarget.style.color = 'var(--accent-blue)'} onMouseOut={e => e.currentTarget.style.color = 'var(--text-secondary)'} aria-label="Email">
              <Mail size={20} />
            </a>
          </div>
        </div>
        ...
        <div className="footer-col">
          ...
          <ul className="footer-links">
            ...
            <li><a href="mailto:support@nexus.app">Contact Us</a></li>
          </ul>
        </div>
      ...
      <div style={{ 
        ...
        <div style={{ color: 'var(--text-secondary)', fontSize: '0.85rem', display: 'flex', alignItems: 'center', gap: '6px' }}>
          &copy; {new Date().getFullYear()} Nexus Downloader. All rights reserved.
        </div>
        
        <div style={{ color: 'var(--text-secondary)', fontSize: '0.85rem', display: 'flex', alignItems: 'center', gap: '6px' }}>
          Made with <Heart size={14} color="var(--accent-purple)" fill="var(--accent-purple)" style={{ display: 'inline' }} /> by Nexus Team
        </div>
      </div>
    </footer>
  );
